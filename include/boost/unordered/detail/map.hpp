  ...
  namespace unordered {
    namespace detail {
      ...
      struct map
      {
        ...
        typedef boost::unordered::detail::false_type is_equiv;
        typedef typename boost::conditional<
          boost::is_same<void_pointer, void*>::value,
          boost::unordered::detail::true_type,
          boost::unordered::detail::false_type>::type uses_raw_pointers;
      };
      ...
      struct multimap
      {
        ...
        typedef boost::unordered::detail::true_type is_equiv;
        typedef typename boost::conditional<
          boost::is_same<void_pointer, void*>::value,
          boost::unordered::detail::true_type,
          boost::unordered::detail::false_type>::type uses_raw_pointers;
